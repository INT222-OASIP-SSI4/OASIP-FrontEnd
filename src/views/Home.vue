  ...
  if (keyword.value) {
    ...
    if (dateStatus.value) {
      if(dateStatus.value == "upcoming"){
        ...
        result = result.filter((e) => (e.eventStartTime >= currentDate.value) || (currentDate.value <= getEndDate(e.eventStartTime, e.eventDuration) && currentDate.value >= e.eventStartTime ) )
      }
      else if (dateStatus.value == "past") {
        status.value = "No Past Events"
        result = result.filter((e) => e.eventStartTime < currentDate.value && currentDate.value > getEndDate(e.eventStartTime, e.eventDuration) ) 
      } 
