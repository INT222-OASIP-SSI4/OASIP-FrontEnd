...
<template>
  <div class="flex items-center mt-4">
    <button
      type="button"
      class="hover:bg-color-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-blue-100 font-medium rounded-lg text-sm px-6 py-2 text-center mr-2 mb-2 capitalize"
      @click="$emit('setCategoryIndex', -1)"
      :class="{ 'bg-blue-500 text-white': activeIndex === -1 }"
    >
      All
    </button>
