...
<template>
  <nav class="sticky w-full top-0 left-0 bg-color-900 shadow-lg to-transparent">
    <div
      class="container flex flex-wrap items-center justify-between mx-auto max-w-screen-xl px-6 md:px-6 py-2.5"
    >
      ...
      <div class="flex items-center md:order-2">
        ...
        <span
          class="self-center text-xl font-semibold whitespace-nowrap dark:text-white p-2"
          >Role: {{ strRole() }}</span
        >
      </div>
